import { SpeechChunk, MemorizationMode } from "./types";
...
export const MODE_DESCRIPTIONS: Record<MemorizationMode, string> = {
  [MemorizationMode.READ]: "Read along while listening to catch the rhythm and emotion. Hearing the speech helps lock it into your memory.",
