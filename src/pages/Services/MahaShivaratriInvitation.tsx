...
const MahaShivaratriInvitation = () => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="max-w-4xl mx-auto">
            <div className="inline-block p-4 sm:p-6 rounded-lg bg-gradient-to-br from-indian-cream to-white border border-indian-saffron shadow-lg transform transition-all duration-500 hover:shadow-xl hover:scale-[1.01] text-center w-full mb-8">
              <h1 className="text-2xl sm:text-3xl font-heading font-bold mb-4 text-black">Maha Shivaratri Celebrations</h1>
              <p className="text-sm sm:text-base text-gray-700">
                Join us for the celebration of Maha Shivaratri - Sunday, 15th February from 6:00 PM to 8:00 PM
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-full max-w-2xl">
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                      <iframe
                        src="/pics/Maha Shivartri 2026 .pdf#zoom=50"
                        width="100%"
                        height="600px"
                        className="border-0 h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px]"
                        title="Maha Shivaratri Programme"
                  ...
                  <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center">
                    <a
                      href="/pics/Maha Shivartri 2026 .pdf"
                      target="_blank"
                    ...
                    <a
                      href="/pics/Maha Shivartri 2026 .pdf"
                      download="Maha_Shivaratri_2026.pdf"
                  ...
                  <div className="mt-8 p-6 bg-indian-cream/50 rounded-lg border border-indian-saffron/20 w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
                      <div>
                        ...
                        <p className="text-indian-saffron font-semibold">Sunday, 15th February from 6:00 PM to 8:00 PM</p>
                      </div>
                      <div>
                    ...
                    <div className="mt-4 text-center">
                      <p className="text-gray-700 mb-2">
                        <strong>Address by:</strong>
                      </p>
                      <p className="text-gray-700 font-semibold">Revered Swami Vipranandaji</p>
                      <p className="text-gray-700 italic mt-2">"Lord Shiva - The Lord who is easily pleased"</p>
                      <p className="text-gray-700 mt-3">
                        The programme will include devotional songs, hymns, and arati.
                      </p>
                    </div>
                  </div>
                </div>
...
export default MahaShivaratriInvitation;
