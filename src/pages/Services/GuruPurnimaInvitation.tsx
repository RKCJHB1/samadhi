...
const GuruPurnimaInvitation = () => {
  const [currentPage, setCurrentPage] = useState(1);
  const [isLoading, setIsLoading] = useState(true);
  const totalPages = 1; // Assuming GP.pdf has 1 page, adjust if needed
                  ...
                  <div className="mt-8 p-6 bg-indian-cream/50 rounded-lg border border-indian-saffron/20 w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
                      <div>
                        ...
                        <p className="text-indian-saffron font-semibold">Thursday, 10th July from 7:00 PM to 8:00 PM</p>
                      </div>
                      <div>
                    ...
                    <div className="mt-4 text-center">
                      <p className="text-gray-700">
                        Join us for this special celebration honoring our spiritual teachers and the tradition of Guru-disciple relationship.
                      </p>
                    </div>
                  </div>
                </div>
...
export default GuruPurnimaInvitation;
