...
const SriSaradaDeviJayantiInvitation = () => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="max-w-4xl mx-auto">
            <div className="inline-block p-4 sm:p-6 rounded-lg bg-gradient-to-br from-indian-cream to-white border border-indian-saffron shadow-lg transform transition-all duration-500 hover:shadow-xl hover:scale-[1.01] text-center w-full mb-8">
              <h1 className="text-2xl sm:text-3xl font-heading font-bold mb-4 text-black">Sri Sarada Devi Jayanti</h1>
              <p className="text-sm sm:text-base text-gray-700">
                Join us for the celebration of Sri Sarada Devi Jayanti - Sunday, 7th December from 10:00 AM to 11:45 AM
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-full max-w-2xl">
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                      <iframe
                        src={`/pics/Sri Sarada Devi Jayanti 2025_final.pdf#page=${currentPage}&zoom=25`}
                        width="100%"
                        height="600px"
                        className="border-0 h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px]"
                        title={`Sri Sarada Devi Jayanti Programme - Page ${currentPage}`}
                  ...
                  <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center">
                    <a
                      href="/pics/Sri Sarada Devi Jayanti 2025_final.pdf"
                      target="_blank"
                    ...
                    <a
                      href="/pics/Sri Sarada Devi Jayanti 2025_final.pdf"
                      download="Sri_Sarada_Devi_Jayanti_2025.pdf"
                  ...
                  <div className="mt-8 p-6 bg-indian-cream/50 rounded-lg border border-indian-saffron/20 w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
                      <div>
                        ...
                        <p className="text-indian-saffron font-semibold">Sunday, 7th December from 10:00 AM to 11:45 AM</p>
                      </div>
                      <div>
                        <p className="font-medium text-gray-700">Venue</p>
                        <p className="text-indian-saffron font-semibold">
                          <a href="https://maps.app.goo.gl/4w3ncE7cXXHaZHqj9" target="_blank" rel="noopener noreferrer" className="hover:underline">
                    ...
                    <div className="mt-4 text-center">
                      ...
                      <p className="text-gray-700 font-semibold">Revered Pravrajika Ishtaprana Mataji</p>
                      <p className="text-gray-700">Head: Sri Sarada Devi Ashram (Asherville)</p>
                      <p className="text-gray-700 mt-3">
                        The programme will include bhajans, shanti mantras, and a performance by the Nateshwar Dance Academy.
                      </p>
                    </div>
                  </div>
                </div>
...
export default SriSaradaDeviJayantiInvitation;
